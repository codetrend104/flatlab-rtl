...
$(document).ready(function() {
	...
	$.slidebars = function(options) {
		...
		function css() {
			...
			if ($left && ($left.hasClass('sb-style-push') || $left.hasClass('sb-style-overlay'))) $left.css('marginRight', '-' + $left.css('width'));
			if ($right && ($right.hasClass('sb-style-push') || $right.hasClass('sb-style-overlay'))) $right.css('marginLeft', '-' + $right.css('width'));
